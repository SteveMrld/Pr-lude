...
function rowToEngineSnapshot(row: TrajectorySnapshotRow): TrajectorySnapshot {
  return {
    ...
    verdict: row.verdict,
    // Les dimensions nulles restent nulles, meme raison que dans le
    // dispatcher d alertes : un repli sur le score global fabriquait
    // des deltas de trajectoire sur des axes jamais instruits.
    dimensions: {
