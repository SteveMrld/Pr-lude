...
const cases = [
  ...
  // ====================================================
  {
    ...
    extraction: {
      ...
      fundraise: { stage: 'seed', amount: '2M EUR', operationType: 'levee' as const, operationTypeEvidence: 'Fixture de test : le stade et le montant modelisent un document de levee.' },
      competitorsCited: [],
  ...
  // ====================================================
  {
    ...
    extraction: {
      ...
      fundraise: { stage: 'series-a', amount: '8M EUR', operationType: 'levee' as const, operationTypeEvidence: 'Fixture de test : le stade et le montant modelisent un document de levee.' },
      competitorsCited: [],
  ...
  // ====================================================
  {
    ...
    extraction: {
      ...
      traction: { metrics: [] },
      fundraise: { stage: 'seed', amount: '3M EUR', operationType: 'levee' as const, operationTypeEvidence: 'Fixture de test : le stade et le montant modelisent un document de levee.' },
      competitorsCited: [],
  ...
  // ====================================================
  {
    ...
    extraction: {
      ...
      traction: { metrics: [] },
      fundraise: { stage: 'seed', amount: '1M EUR', operationType: 'levee' as const, operationTypeEvidence: 'Fixture de test : le stade et le montant modelisent un document de levee.' },
      competitorsCited: [],
  ...
  // ====================================================
  {
    ...
    extraction: {
      ...
      fundraise: { stage: 'seed', amount: '500K EUR', operationType: 'levee' as const, operationTypeEvidence: 'Fixture de test : le stade et le montant modelisent un document de levee.' },
      competitorsCited: [],
  ...
  // ====================================================
  {
    ...
    extraction: {
      ...
      traction: { metrics: [] },
      fundraise: { stage: 'series-c-plus', amount: '80M EUR', operationType: 'levee' as const, operationTypeEvidence: 'Fixture de test : le stade et le montant modelisent un document de levee.' },
      competitorsCited: [],
