// ============================================================
// Tests deterministes du fingerprint de version stamp
// ------------------------------------------------------------
// Ce fichier s appelait prediction-records-store.test.ts et ne
// touchait pas ce store : il verifie que fingerprintStamp recompose
// les colonnes stamp_* de facon stable et discriminante. Le nom
// affirmait une couverture qui n existait pas, et le store est
// desormais couvert par son propre fichier.
// ============================================================

import { buildVersionStamp, fingerprintStamp } from './version-stamp';
